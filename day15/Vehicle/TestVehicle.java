...
public class TestVehicle {
    public static void main(String[] args) {
        ...
        Vehicle myVeh=emp.buyVehicle(1200000);  //new Car()  //0x11223344
        if (myVeh != null){
            emp.goHome(myVeh);
        }
//---------------instanceof关键字转换------------------------------------------------
...
class Employee {   //员工
    ...
    //---->多态
    //回家工具   父类作为方法形参
    public void goHome(Vehicle veh) {  // Vehicle veh=new ...();
        System.out.print("下班了，" + name + "正在乘坐");
        veh.run();
    }

    //买车   父类作为方法返回值
    public Vehicle buyVehicle(int money) {   //买车预算
